...
const Rentcar = () => {
    ...
    const changeinfodefault = () => {
        seta({ image: img2, price: "45$", model: "Audi", mark: "AI", year: "2012", door: "4/5", AC: "Yes", transmission: "Manual", fule: "Gasoline" });
    ...
    const changeinfo = () => {
        seta({ image: img3, price: "37$", model: "Golf 6", mark: "Volkswagen", year: "2008", door: "4/5", AC: "Yes", transmission: "Automatic", fule: "Diesel" });
    ...
    const changeinfo2 = () => {
        seta({ image: img4, price: "30$", model: "Camry", mark: "Toyota", year: "2006", door: "4/5", AC: "Yes", transmission: "Automatic", fule: "Hybrid" });
    ...
    const changeinfo3 = () => {
        seta({ image: img5, price: "35$", model: "320", mark: "BMW", year: "2012", door: "4/5", AC: "Yes", transmission: "Manual", fule: "Diesle" });
    ...
    const changeinfo4 = () => {
        seta({ image: img6, price: "50$", model: "Benz GLK", mark: "Mercedes", year: "2006", door: "4/5", AC: "Yes", transmission: "Manual", fule: "Diesel" });
    ...
    const changeinfo5 = () => {
        seta({ image: img7, price: "25$", model: "Passat CC", mark: "Volkswagen", year: "2008", door: "4/5", AC: "Yes", transmission: "Automatic", fule: "Gasoline" });
    ...
    return (
        < div className='rentcar'>
            ...
            <div className="page4 animation" data-aos="flip-right">
            ...
            <div className="page5" id='team'>
                <div className="tripplan">
                    ...
                    <div className="tripplan-detail animation" data-aos="fade-up">
            ...
            <div className="page6 animation" data-aos="zoom-in" id='model'>
                <div className="vehiclemodel">
                    ...
                    <div className="vehicleretail">
                        <div className="vehicletype">
                            <h3 id="Audi" className='cartype one' onClick={changeinfodefault} >Audi A1 S-Line</h3>
                            <h3 id="Golf" className='cartype two' onClick={changeinfo}>VW Golf 6</h3>
                            <h3 id="Camry" className='cartype three' onClick={changeinfo2}>Toyota Camry</h3>
                            <h3 id="MordernLine" className='cartype four' onClick={changeinfo3}>BMW 320 MordernLine</h3>
                            <h3 id="Merceedes" className='cartype five' onClick={changeinfo4}>Merceedes-Benz GLK</h3>
                            <h3 id="Passat" className='cartype six' onClick={changeinfo5}>VW Passat CC</h3>
                        </div>
                        <img src={a.image} alt="cartype" width="50%" className='car' />
                            ...
                            <div className="vehicleprice-detail">
                                <div className="vp-detail">
                                    ...
                                    <div className="vp-detail-right">
                                        <p className='vp-detail-item'>{a.model}</p>
                                        <p className='vp-detail-item' >{a.mark}</p>
                                        <p className='vp-detail-item' >{a.year}</p>
                                        <p className='vp-detail-item' >{a.door}</p>
                                        <p className='vp-detail-item' >{a.AC}</p>
                                        <p className='vp-detail-item' >{a.transmission}</p>
                                        <p className='vp-detail-item' >{a.fule}</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="page7" id='about'>
                ...
                <div className="page7-footer" >
                    <div className="page7-footer-left animation" data-aos="fade-right">
                        <h3>Why Choose Us</h3>
                    ...
                    <div className="page7-footer-right animation" data-aos="fade-left">
            ...
            <div className="page8 animation" data-aos="zoom-in">
            ...
            <div className="page9 animation" data-aos="zoom-out">
            ...
            <div className="page10 animation" data-aos="zoom-out" id='contact'>
